...
import com.android.serialport.adapter.LogListAdapter;
import com.android.serialport.adapter.SpAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recv_msg = (TextView) findViewById(R.id.recv_msg);
        ...
        serialHelper = new SerialHelper("dev/ttyS2", 19200) {
            @Override
                    ...
                    public void run() {
                        if (radioGroup.getCheckedRadioButtonId() == R.id.radioButton1) {
                            try {
                                ...
                                recv_msg.setText(new String(comBean.bRec, "UTF-8"));
                            ...
                            recv_msg.setText(ByteUtil.ByteArrToHex(comBean.bRec));
